...
class SignalManager:
    ...
    """
    def __init__(self, flow_manager: FlowManager, alert_manager: AlertManager, model, attack_probability_threshold: float):
    ...
    def _predict_attack_probability(self, input_vector: pd.DataFrame) -> float:
        print(self._model.predict_proba(input_vector))
